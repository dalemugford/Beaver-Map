(function($){
     ...
     */
    FLBuilder._registerModuleHelper('dale-google-map', {
     ...
     */
    FLBuilder._registerModuleHelper('dale_settings_form', {
        ...
        submit: function()
        {
            var result = confirm('Do you really want to save this pin?');
